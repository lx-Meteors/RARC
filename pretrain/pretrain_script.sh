...
#python pre_prepare_data.py --work_dir '../experiment/main_experiment/RARC_1B'

nohup python ./pre_trainer.py --work_dir '../experiment/main_experiment/RARC_1B' --port 14571 > train.log 2>&1 &
python ./pre_evaluator.py --work_dir '../experiment/main_experiment/RARC_1B' --batch_size 1
