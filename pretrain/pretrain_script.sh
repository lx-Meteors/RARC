...
python ./pre_trainer.py --work_dir '../experiment/rebuttal/15x_8gpu/SAC_Learned_Selection' --port 14572
python ./pre_evaluator.py --work_dir '../experiment/rebuttal/15x_8gpu/SAC_Learned_Selection' --batch_size 1

python ./pre_trainer.py --work_dir '../experiment/rebuttal/5x_8gpu/SAC_Learned_Selection' --port 14574
python ./pre_evaluator.py --work_dir '../experiment/rebuttal/5x_8gpu/SAC_Learned_Selection' --batch_size 1

cd ..
cd sft

python ./instruction_trainer.py --work_dir   '../experiment/rebuttal/15x_8gpu/SAC_Learned_Selection' --port 14527
python ./instruction_evaluator.py --work_dir   '../experiment/rebuttal/15x_8gpu/SAC_Learned_Selection' --batch_size 1

python ./instruction_trainer.py --work_dir   '../experiment/rebuttal/5x_8gpu/SAC_Learned_Selection' --port 14529
python ./instruction_evaluator.py --work_dir   '../experiment/rebuttal/5x_8gpu/SAC_Learned_Selection' --batch_size 1
