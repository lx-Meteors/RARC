...
cd ..
cd sft
python ./instruction_trainer.py --work_dir   '../experiment/rebuttal/51x_8gpu/SAC_qmsum' --port 14527
python ./instruction_evaluator.py --work_dir   '../experiment/rebuttal/51x_8gpu/SAC_qmsum' --batch_size 1
