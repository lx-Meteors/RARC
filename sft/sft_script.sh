...
#python instruction_prepare_data.py --work_dir  '../experiment/rebuttal/15x_8gpu/SAC_qmsum_govreport'
...
/mnt/zhaorunsong/lx/RARC/experiment/rebuttal/15x_8gpu/SAC_qmsum_govreport