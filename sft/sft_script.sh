...
CUDA_VISIBLE_DEVICES=0 python ./instruction_evaluator.py --work_dir   '../experiment/test_time/15x/SAC' --batch_size 1
...
/mnt/zhaorunsong/lx/RARC/experiment/test_time/15x/SAC
# 后台启动方式
