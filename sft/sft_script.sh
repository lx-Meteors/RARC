...
python instruction_prepare_data.py --work_dir  '../experiment/rebuttal/51x_8gpu/SAC_LongBench'
...
python ./instruction_evaluator.py --work_dir    '../experiment/rebuttal/15x_8gpu/test' --batch_size 1
...
python ../util/evaluate_longbench.py --work_dir '../experiment/rebuttal/15x_8gpu/test'

# 后台启动方式
#nohup python ./instruction_trainer.py --work_dir   '../experiment/main_experiment/ICAE_EPL_1B' --port 14527 > train.log 2>&1 &
# tail -f train.log
/mnt/zhaorunsong/lx/RARC/experiment/rebuttal/15x_8gpu/test